...
export default function HomeHero({ dict }: HomeHeroProps) {
    ...
    return (
        <section ref={containerRef} className="relative h-screen w-full flex flex-col items-center overflow-hidden bg-[#050505]" suppressHydrationWarning>
            ...
            {/* Utilisation de mt-auto pour pousser le bloc vers le bas et mb pour la distance avec le bord */}
            <div className="hero-content opacity-0 relative z-10 container mx-auto px-6 flex flex-col items-center text-center select-none mt-auto mb-16 md:mb-32">
