        ...
        <main ref={containerRef} className="min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden selection:bg-[#FFD700] selection:text-black">
            ...
            <section className="relative min-h-[90vh] flex flex-col justify-center px-6 md:px-20 pt-20">
                <div className="max-w-7xl">
                    <div className="relative mb-8 inline-block max-w-full">
                        ...
                        <div className="hero-title-mask absolute top-0 left-0 h-full bg-[#FFD700] overflow-hidden z-20 w-0">
                    ...
                    <p className="hero-content text-xl md:text-3xl font-serif italic text-white/80 max-w-4xl leading-relaxed border-l-4 border-[#FFD700] pl-8">
                        {content.subtitle}
                    </p>
                </div>
            </section>
            ...
            <section className="what-we-do-section py-32 px-6 md:px-20 container mx-auto">
                <div className="grid lg:grid-cols-12 gap-16">
                    <div className="lg:col-span-4">
                        <span className="text-[#FFD700] font-mono text-sm uppercase tracking-widest mb-4 block">01 / {content.step_labels?.expertise}</span>
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {whatWeDo.bullets.map((item: string, i: number) => (
                                <div key={i} className="what-we-do-item flex gap-4 p-6 border border-white/10 hover:border-[#FFD700] transition-colors bg-[#0A0A0A]">
            ...
            <section className="py-32 bg-[#080808]">
                <div className="container mx-auto px-6 md:px-20">
                    <div className="mb-20 text-center max-w-3xl mx-auto">
                        <span className="text-[#FFD700] font-mono text-sm uppercase tracking-widest mb-4 block">02 / {content.step_labels?.process}</span>
                    ...
                    <div className="relative max-w-4xl mx-auto" ref={timelineRef}>
                        {/* Vertical Line */}
                        <div className="absolute left-8 top-0 bottom-0 w-[1px] bg-gradient-to-b from-transparent via-[#FFD700] to-transparent hidden md:block" />
                        ...
                        <div className="space-y-16">
                            {ourApproach.steps.map((step: any, i: number) => (
                                <div key={i} className="timeline-step flex flex-col md:flex-row gap-8 items-start relative group">
                                    <div className="md:w-16 h-16 rounded-full bg-[#111] border border-[#FFD700] flex items-center justify-center text-[#FFD700] font-bold z-10 shrink-0 text-xl font-display">
                                        {i + 1}
                                    </div>
                                    <div className="pt-2">
                                        <h3 className="text-3xl font-display uppercase mb-2 group-hover:text-[#FFD700] transition-colors">{step.title}</h3>
            ...
            <section className="formats-section py-32 px-6 md:px-20 container mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                    <div>
                        <span className="text-[#FFD700] font-mono text-sm uppercase tracking-widest mb-4 block">03 / {content.step_labels?.activation}</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {formats.items.map((item: any, i: number) => (
                        <div key={i} className="format-card p-10 bg-[#111] hover:bg-[#1a1a1a] transition-colors group border-t-2 border-transparent hover:border-[#FFD700]">
                            <h3 className="text-xl font-display uppercase mb-4 text-white group-hover:text-[#FFD700]">{item.title}</h3>
            ...
            <section className="py-20 px-6 container mx-auto border-t border-white/5">
                <div className="grid lg:grid-cols-2 gap-20">
                    ...
                    <div className="bg-[#111] p-12 relative overflow-hidden">
                        <ArrowDownLeft className="absolute top-8 right-8 text-[#FFD700] w-12 h-12" />
            ...
            <section className="py-40 px-6 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    ...
                    <SonicButton href={`${cta.primaryButton.href}?type=influence`} variant="influence" className="border border-[#FFD700] text-[#FFD700] hover:bg-[#FFD700] hover:text-black px-12 py-5 uppercase font-bold tracking-widest text-lg transition-colors">
